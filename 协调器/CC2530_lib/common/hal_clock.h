//-------------------------------------------------------------------
// Filename: hal_clock.h
// Description: This file defines interface for clock related functions
//-------------------------------------------------------------------
//-------------------------------------------------------------------
// CONSTANTS
//-------------------------------------------------------------------
...
#define CC2530_SET_TICKSPD(x)        st( CLKCONCMD = ((((x) << 3) & 0x38)  | (CLKCONCMD & 0xC7)); )

// Macro for setting the timer tick division factor, x value from 0b000 to 0b111
#define CC2530_SET_CLKSPD(x)         st( CLKCONCMD = (((x) & 0x07)| (CLKCONCMD & 0xF8)); )
